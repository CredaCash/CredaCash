...
#define CC_TYPE_XCX_MINING_TRADE	13
#define CC_TYPE_XCX_MINING_BUY		14
#define CC_TYPE_XCX_MINING_SELL		15
#define CC_TYPE_INVALID				16
...
#define CC_TAG_XCX_SIMPLE_TRADE			0xCC1a0001
#define CC_TAG_LAST_OBJ					CC_TAG_XCX_SIMPLE_TRADE
